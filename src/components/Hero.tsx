          ...
          <div className="relative z-10 flex flex-col gap-8 justify-center">
            ...
            <div className="space-y-5">
              ...
              <p className="max-w-xl text-base leading-relaxed text-cyan-50/90 sm:text-lg">
                ...
                presence across Asia, the Middle East, the UK, and the USA
                empowers industries worldwide with reliable, accredited
                bio-based solutions for biodiesel, oleochemicals, energy, and
