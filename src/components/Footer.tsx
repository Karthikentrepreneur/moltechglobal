...
// ✅ Updated offices with full addresses and phones
const offices = [
  {
    country: "AUSTRALIA",
      ...
      <footer className="bg-black text-white">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            <div
              className={`mx-auto mt-8 h-[3px] w-full max-w-5xl ${GRADIENT_BG} rounded-full`}
            />
            <button
              onClick={scrollTop}
          ...
          <div className="py-10 grid grid-cols-1 gap-10 md:grid-cols-3 items-start">
            ...
            <div className="flex flex-col justify-start">
              ...
              <p className="text-white/80 leading-relaxed text-sm md:text-[15px] max-w-md">
                ...
                reduce carbon footprint. With a global presence and strong
                ethics, we're committed to performance, transparency, and
                community impact.
              </p>
            </div>
              ...
              <ul className="space-y-3">
                {quickLinks.map((item) => (
                  <li key={item.label} className="flex items-center gap-3">
                    <span
                      className={`inline-block h-2 w-2 rounded-full ${GRADIENT_BG}`}
                    />
                    <a
                      href={item.href}
            ...
            <div className="flex flex-col justify-start">
              ...
              >
                <span
                  className={`inline-grid place-items-center ${GRADIENT_BG} rounded-full p-1`}
                >
              ...
              <h5 className="text-sm font-semibold mt-6 mb-3 text-white/80">
                Global Offices
              </h5>
              <div
                ...
                >
                  <div className="office-chip">
                    <div className="office-chip__inner text-left">
                      <div className="office-chip__title">
                        {offices[index].country}
                      </div>
                      <div className="office-chip__line">
                        {offices[index].address}
                      </div>
                      <div className="office-chip__sub">
                        {offices[index].phone}
                      </div>
                    </div>
                  </div>
