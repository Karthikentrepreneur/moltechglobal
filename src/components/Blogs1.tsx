...
import Blogs1 from "../components/Blogs1";   // ⭐ ADDED
  ...
  return (
    <>
      ...
      <main className="bg-white text-[#0F1B3D]">
          ...
          <div className="relative h-[38vh] md:h-[50vh] lg:h-[56vh]">
            ...
            <div className="relative z-10 flex h-full items-center justify-center text-center px-6">
              <div>
                ...
                {/* ⭐ Breadcrumb removed – Blogs1 added */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-6">
              ...
              <p className="mt-5 text-[17px] leading-8 text-slate-700">
                ...
                that drive the circular economy. With strategic presence in Asia,
                Middle East, United Kingdom and United States of America,
                Moltech harnesses global renewable potential.
              </p>
              ...
              <div className="mt-8 space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 mt-1">
                      HQ in Singapore with operations across Malaysia, Thailand,
                      Indonesia, UAE, UK and USA.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 mt-1">
                      ISCC (EU) certified – strong governance & ethical operations.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-10">
                <Link
                  to="/contact"
                  className="inline-flex items-center justify-center px-6 py-3 text-sm font-semibold text-white rounded-full shadow-md bg-gradient-to-r from-blue-600 to-blue-400 hover:from-blue-700 hover:to-blue-500"
                >
                  Contact Us
                </Link>
              </div>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="space-y-5 text-[16.5px] leading-8 text-slate-700">
              <p>
                ...
                Thailand, Indonesia, UAE, UK and USA. Part of a larger global
                group, our network is robust and rapidly scalable.
              </p>
              <p>
                We collect and process used cooking oil, tyre-derived oils,
                acid oils and POME for renewable fuels. Our feed division
                supplies formulated feed fats for livestock.
              </p>
              <p>
                With a global team and modern tech, we uphold ethics, quality
        ...
        {/* ===== Purpose + Vision + Mission new section ===== */}
        <section className="mx-auto max-w-7xl px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="mt-4 text-[17px] text-slate-600 max-w-3xl mx-auto leading-7">
              Moves the world closer to renewable, low-carbon energy. Small
              actions create global impact.
            </p>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="rounded-2xl bg-white p-8 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-slate-100">
              ...
              <p className="mt-4 text-[16px] text-slate-700 leading-7">
                Engage in sustainable bio-space activities that reduce carbon
            ...
            <div className="rounded-2xl bg-white p-8 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-slate-100">
              ...
              <p className="mt-4 text-[16px] text-slate-700 leading-7">
                Scale up sustainable feedstock collection, operate ethically,
