  ...
  return (
    <div className="w-full h-full flex justify-center">
      <div
        ...
        } my-3 border border-royal-blue/10`}
      >
        {/* Map Header */}
        <div className="flex justify-between items-center p-3 border-b border-royal-blue/20 bg-gradient-to-r from-royal-blue/10 to-electric-blue/10">
          <h3 className="font-medium text-deep-navy flex items-center">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="text-royal-blue border-royal-blue/40 hover:bg-royal-blue/10"
            >
          ...
          {!isLoaded && (
            <div className="absolute inset-0 flex items-center justify-center bg-white bg-opacity-80 z-10">
              <div className="flex flex-col items-center">
                ...
                <p className="mt-3 text-sm text-deep-navy/80">Loading map...</p>
              </div>
            </div>
          )}
        </div>
        ...
        {/* Map Footer */}
        <div className="py-2 px-4 border-t border-royal-blue/20 bg-gradient-to-r from-white to-royal-blue/10 text-xs text-deep-navy/80 text-center">
