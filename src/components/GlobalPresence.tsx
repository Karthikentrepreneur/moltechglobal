  ...
  return (
    <section className="section-padding bg-deep-navy text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        {/* Google Maps World View with All Locations */}
        <div className="relative mb-16">
          <div className="glass-card p-8 relative overflow-hidden">
            <div className="relative h-[600px] rounded-2xl overflow-hidden shadow-2xl">
              <iframe
                src="https://www.google.com/maps/d/embed?mid=1_YOUR_MAP_ID&ehbc=2E312F"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Global Office Locations - World Map"
              />
            </div>
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 ${
                    selectedCountryIdx === idx
                      ? "bg-electric-blue text-white shadow-lg scale-105"
                      : "bg-white/10 text-blue-200 hover:bg-white/20 hover:text-white"
                  }`}
                  aria-label={`View ${country.name} office`}
                >
                  {country.name}
                </button>
              ))}
