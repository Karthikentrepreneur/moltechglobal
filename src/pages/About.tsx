    ...
    <main className="pt-20 bg-white text-gray-900">
      ...
      <section className="relative min-h-[55vh]">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/images/about-hero.jpg')", // <- put your hero image here
      ...
      <section className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 py-12 md:grid-cols-2 lg:px-8">
        <div className="prose prose-lg max-w-none text-gray-700">
          ...
          <p>
            ...
            Malaysia, Thailand, Indonesia, UAE, UK and USA. Being part of a larger group with
            it's presence in more than 15 countries, Moltech takes further leverage of cross
            functional support from its allied offices which makes its network more robust and
            potential to expand.
          </p>
          <p>
            Moltech operates collection and processing of feedstock for renewable diesel at its
            own locations catering to the biodiesel industry. Products like Used cooking oil,
            Tyre derived oils, Acid oils and POME are few of them. The Feed division works on
            vegetable oil based specially formulated feed fats both liquid and dry forms. The
            industrial application sector is catered through products like Fatty alcohols, Fatty
            acid esters and glycerol.
          </p>
          <p>
            Equipped with a global team of highly trained employees and with effective use of
            technology, Moltech operates with high standards of ethics, operational excellence,
            quality control and transparency which paved the way for Moltech to become one of the
            most reliable partners on a global scale.
          </p>
        ...
        <div className="overflow-hidden rounded-2xl bg-gray-100">
          <img
            src="/images/about-intro.jpg" // <- replace with your image
      ...
      <section className="border-y border-gray-200 bg-white">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-6 py-10 md:grid-cols-4 lg:px-8">
          <div className="flex items-center gap-5">
            <div className="grid h-16 w-16 place-items-center rounded-2xl bg-blue-50">
      ...
      <section className="mx-auto max-w-7xl px-6 py-14 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="relative overflow-hidden rounded-2xl">
            <img
              src="/images/vision.jpg" // <- your background image
              alt="Vision"
            ...
            <div className="relative p-8 sm:p-10 md:p-12 text-white">
              ...
              <p className="mt-6 max-w-xl text-white/95 text-lg leading-relaxed">
                To engage in business and services in the bio-space which contribute to reduction in carbon
                footprint and environmental care
              </p>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-2xl">
            <img
              src="/images/mission.jpg" // <- your background image
              alt="Mission"
              className="absolute inset-0 h-full w-full object-cover"
            />
            ...
            <div className="relative p-8 sm:p-10 md:p-12 text-white">
              ...
              <ul className="mt-6 max-w-2xl list-disc space-y-3 pl-5 text-white/95 text-lg leading-relaxed">
                <li>
                  To scale up the collection and processing of sustainable feedstock for production of clean
                  energy across different continents.
                </li>
