...
const Blog = () => {
  ...
  const blogPosts = [
    {
      title:
        "Circular Economy in Action: Palm Oil Waste to Valuable Products",
      excerpt:
    ...
    {
      title:
        "ISCC Certification: Ensuring Sustainability in Global Supply Chains",
      excerpt:
    ...
    {
      title:
        "Feed Additives Innovation: Optimizing Animal Nutrition Naturally",
      excerpt:
    ...
    {
      title:
        "Global Expansion: Opening New Markets in Renewable Energy",
      excerpt:
        "How Moltech is expanding its presence in North American and European renewable energy markets with innovative biodiesel solutions.",
      image:
    ...
    {
      title:
        "Technology Integration: AI in Sustainable Manufacturing",
      excerpt:
        "Discover how artificial intelligence and machine learning are optimizing our production processes and improving product quality.",
      image:
    ...
    {
      title:
        "Partnerships for Sustainability: Collaborating for Impact",
      excerpt:
        "Learn about our strategic partnerships with global organizations to accelerate the adoption of sustainable bio-based products worldwide.",
      image:
        "https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=600&h=300&fit=crop",
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            <div className="bg-white rounded-3xl p-12 shadow-lg">
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                ...
                sustainable innovation, industry trends, and Moltech updates.
              </p>
