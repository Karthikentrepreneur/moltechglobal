...
const Contact: React.FC = () => {
  ...
  return (
    <main className="bg-white text-gray-900 pt-0">
      {/* ---------- HERO (same vibe as product pages) ---------- */}
      <section className="relative h-[50vh] md:h-[60vh] lg:h-[70vh] -mt-20 flex items-center">
        <img
          src="/businessman.jpg"
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 w-full">
          {/* keep hero minimal like product pages; headline remains below in the card per request */}
          <div className="mx-auto mb-6 inline-flex items-center justify-center rounded-2xl bg-blue-600/85 p-4 w-max">
            <Headset className="h-8 w-8 text-white" />
          </div>
        </div>
      </section>

      {/* ---------- BELOW-HERO SECTION (styled like FattyAcids) ---------- */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-14">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* LEFT: Main content card with big rounded image + heading + body (content unchanged) */}
          <article className="lg:col-span-2">
            <div className="rounded-xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.08)] bg-white">
              <div className="px-6 sm:px-8 pt-8">
                {/* Rounded, bordered image to mirror product page cards */}
                <img
                  src="/contact.png"
              ...
              <div className="px-6 sm:px-8 pb-8 mt-6">
                {/* Heading row with gradient icon box (pattern parity) */}
                ...
                {/* --- Your original H1 (unchanged text) --- */}
          ...
          {/* RIGHT: Sidebar card (channels + form), styled like sidebar cards on product pages */}
          <aside className="space-y-6">
            {/* Channels (Email / Call / Hours) */}
